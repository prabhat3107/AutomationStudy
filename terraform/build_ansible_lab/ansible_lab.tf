...
resource "vsphere_virtual_machine" "userver1" {
  folder = "AnsibleLab2"
  name             = "userver1"
  num_cpus         = 2
  memory           = 4096
...
resource "vsphere_virtual_machine" "userver2" {
  folder = "AnsibleLab2"
  name             = "userver2"
  num_cpus         = 2
  memory           = 4096
...
resource "vsphere_virtual_machine" "userver3" {
  folder = "AnsibleLab2"
  name             = "userver3"
  num_cpus         = 2
  memory           = 4096
...
resource "vsphere_virtual_machine" "rhel8s1" {
  folder = "AnsibleLab2"
  name             = "rhel8s1"
  num_cpus         = 2
  memory           = 4096
  datastore_id     = data.vsphere_datastore.datastore.id
  resource_pool_id = data.vsphere_resource_pool.pool.id
  guest_id         = data.vsphere_virtual_machine.template_rhel8.guest_id
  firmware         = data.vsphere_virtual_machine.template_rhel8.firmware
  ...
  clone {
    template_uuid = data.vsphere_virtual_machine.template_rhel8.id
...
resource "vsphere_virtual_machine" "rhel8s2" {
  folder = "AnsibleLab2"
  name             = "rhel8s2"
  num_cpus         = 2
  memory           = 4096
...
resource "vsphere_virtual_machine" "rhel8s3" {
  folder = "AnsibleLab2"
  name             = "rhel8s3"
  num_cpus         = 2
  memory           = 4096
...
# Set vm parameters
resource "vsphere_virtual_machine" "cos8s2" {
  folder = "AnsibleLab2"
  name             = "cos8s2"
  num_cpus         = 2
  memory           = 4096
...
# Set vm parameters
resource "vsphere_virtual_machine" "cos8s3" {
  folder = "AnsibleLab2"
  name             = "cos8s3"
  num_cpus         = 2
  memory           = 4096
